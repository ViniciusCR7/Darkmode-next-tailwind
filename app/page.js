...
<img class="size-10  hover:scale-110   hovertransition duration-500  min-w-10 min-h-10  hidden dark:flex" src="img/menuB.svg"/>
      ...
      <ul class={`flex flex-col lg:flex-row gap-4  items-center   text-xl lg:text-2xl  dark:lg:bg-transparent lg:bg-transparent min-w-32 min-h-36 lg:min-w-0 lg:min-h-0  ${
            ...
            <li class="duration-300 text-white lg:text-black dark:text-white cursor-pointer mt-3 lg:mt-0 group hover:text-blue-500 dark:hover:text-orange-300 hover:lg:text-inherit ">about me
            ...
            <li class="duration-300 text-white lg:text-black dark:text-white cursor-pointer group hover:text-blue-500 dark:hover:text-orange-300 hover:lg:text-inherit ">my projects
            <div class="hidden lg:flex mx-auto bg-myBlue dark:bg-myOrange w-100% h-px  animate-hoverlineout group-hover:animate-hoverlinein hover:bg-[#fa4521]  "></div>
            </li>
            <li class="duration-300 text-white lg:text-black dark:text-white cursor-pointer  group hover:text-blue-500 dark:hover:text-orange-300 hover:lg:text-inherit ">Contact
            <div class="hidden lg:flex mx-auto bg-myBlue dark:bg-myOrange w-100% h-px  animate-hoverlineout group-hover:animate-hoverlinein hover:bg-[#fa4521] "></div>
            </li>
     </ul>
        </div>
    ...
    <div class="flex flex-col gap-2 font-poppins items-center mb-4  md:hidden ">
     ...
     <a class=" dark:bg-myOrange	rounded-md py-0.5 px-6 cursor-pointer lg:cursor-default  dark:hover:bg-[#892814] font-poppins ">
